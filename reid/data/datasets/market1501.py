...
class Market1501(BaseImageDataset):
    ...
    def __init__(self, root='query', verbose=True, **kwargs):
        ...
        self.query = query    # (img_path, pidm, camid)，pid，每个人的标签编号

        self.num_query_pids, self.num_query_imgs, self.num_query_cams = self.get_imagedata_info(self.query)
        # print("self.num_query_pids:", self.num_query_pids)
        # print("self.num_query_imgs:", self.num_query_imgs)
        # print("self.num_query_imgs:", self.num_query_cams)
